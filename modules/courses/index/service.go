...
func (s *courseService) GetAll(requestID string) ([]entities.Course, error) {
	utils.LogInfo("courses", "get_all", "Fetching all courses", requestID, 0, nil)
...
func (s *courseService) GetByID(id uint, requestID string) (*entities.Course, error) {
